...
from fast_qwen.arch.qwen_torch import Qwen3
from fast_qwen.arch.qwen_fast_cuda import FastQwen3
from fast_qwen.config import QwenConfig_bfloat16 , QwenConfig_float16

from fast_qwen.load_weights import load_weights_fastqwen , load_weights_qwen
...
model : FastQwen3 = FastQwen3(config)
# model = Qwen3(config)
